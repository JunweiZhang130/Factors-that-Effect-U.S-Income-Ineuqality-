...
library(ggplot2)
### Input data ###
income_race<-read.csv(here::here("outputs/data/race_income_data.csv"))

ggplot(subset_data_freq, aes(x = income, y = freq, fill = race)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  scale_x_discrete(labels = c("LT $1000","", "$1000 TO 2999","", "$3000 TO 3999","",
                              "$4000 TO 4999","", "$5000 TO 5999","","$6000 TO 6999", "",
                              "$7000 TO 7999","","$8000 TO 9999","","$10000 - 14999","",
                              "$15000 - 19999","","$20000 - 24999","","$25000 OR MORE")) +
  labs(y = "Numbers of people", title = "Numbers of people of Income by race") +
  theme_minimal() +
...
ggplot(subset_data_freq, aes(x = income, y = freq, fill = edu_year)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  scale_x_discrete(labels = c("LT $1000","", "$1000 TO 2999","", "$3000 TO 3999","",
                              "$4000 TO 4999","", "$5000 TO 5999","","$6000 TO 6999", "",
                              "$7000 TO 7999","","$8000 TO 9999","","$10000 - 14999","",
