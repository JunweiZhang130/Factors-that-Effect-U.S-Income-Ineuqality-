...
marital_status_data$Marital_status <- ifelse(marital_status_data$Marital_status == 1, 
                                             marital_status_replacements[1],
                                           ifelse(marital_status_data$Marital_status == 2, 
                                                  marital_status_replacements[2],
                                                  ifelse(marital_status_data$Marital_status == 3, 
                                                         marital_status_replacements[3],
                                                         ifelse(marital_status_data$Marital_status == 4, 
                                                                marital_status_replacements[4],
...
marital_status_data$Happy_level <- ifelse(marital_status_data$Happy_level == 1, 
                                    happy_replacements[1],
                                   ifelse(marital_status_data$Happy_level == 2, 
                                          happy_replacements[2],
